    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'Student'), ('vendor', 'Vendor'), ('admin', 'Administrator')], default='student', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hostel_block', models.CharField(blank=True, max_length=50)),
                ('room_number', models.CharField(blank=True, max_length=10)),
                ('campus_building', models.CharField(blank=True, max_length=100)),
